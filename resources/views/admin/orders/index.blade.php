                        ...
                        <div class="table-responsive">
                            <div class="col-sm-6 right" style="width: 100%;">
                                <div style="margin-top:20px; margin-bottom:20px">
                                    ...
                                    <a href="{{ route('orders.create') }}" class="btn btn-primary"> <svg class="bi bi-plus-circle-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            ...
                                            <div class="row action-button" style="padding-left: 10px;">
                                                ...
                                                <div class="action-edit">
                                                    <a href="{{ route('orders.edit', $orders->id) }}" class="btn btn-warning"><i class='fas fa-edit'></i>Edit</a>
